...
const GptSearchBar = () => {
  ...
  const handleGptSearchClick = async () => {
    ...
    //gptMovies will be a array of movies

    //For each movie search TMDB API
    const promiseArray = gptMovies.map((movie) => searchTMDB(movie));

    //So the above will data will give us only array of promises like [Promise, Promise, Promise, Promise, Promise]
  ...
  return (
    <div className="pt-[45%] md:pt-[10%] flex justify-center">
      ...
      >
        ...
        />
        <button
          className="col-span-3 m-4 py-2 bg-red-700"
