...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form onSubmit={(e) => e.preventDefault()} className="w-[28%] p-12 bg-black absolute my-36 mx-auto right-0 left-0 text-white bg-opacity-80 rounded-lg">
        ...
        <button className="p-6 my-6 bg-red-700 w-full rounded-lg" onClick={handleButtonClick}>
          {isSignInForm ? "Sign In" : "Sign Up"}
        </button>
